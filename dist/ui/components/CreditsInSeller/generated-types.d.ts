...
export type TransferCreditfromSellerToCustomerQuery = {
    __typename?: 'Query';
...
export declare const TransferCreditfromSellerToCustomerDocument: DocumentNode<TransferCreditfromSellerToCustomerQuery, Exact<{
    value: Scalars['Int']['input'];
    sellerId: Scalars['ID']['input'];
}>>;

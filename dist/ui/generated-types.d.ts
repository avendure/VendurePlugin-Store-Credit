...
export declare const StoreCreditsFragmentDoc: DocumentNode<StoreCreditsFragment, unknown>;
export declare const StoreCreditFragmentDoc: DocumentNode<StoreCreditFragment, unknown>;
export declare const AccountBalanceFragmentDoc: DocumentNode<AccountBalanceFragment, unknown>;
export declare const TransferCreditfromSellerToCustomerDocument: DocumentNode<TransferCreditfromSellerToCustomerMutation, Exact<{
    value: Scalars['Int']['input'];
    sellerId: Scalars['ID']['input'];
}>>;
export declare const GetSellerAndCustomerStoreCreditsDocument: DocumentNode<GetSellerAndCustomerStoreCreditsQuery, Exact<{
    sellerId: Scalars['ID']['input'];
}>>;
export declare const GetAllStoreCreditsDocument: DocumentNode<GetAllStoreCreditsQuery, Exact<{
    options?: StoreCreditListOptions | undefined;
}>>;
export declare const GetStoreCreditDocument: DocumentNode<GetStoreCreditQuery, Exact<{
    id: Scalars['ID']['input'];
}>>;
export declare const DeleteStoreCreditDocument: DocumentNode<DeleteStoreCreditMutation, Exact<{
    input: Scalars['ID']['input'];
}>>;
export declare const UpdateStoreCreditDocument: DocumentNode<UpdateStoreCreditMutation, Exact<{
    input: StoreCreditUpdateInput;
}>>;
export declare const CreateStoreCreditDocument: DocumentNode<CreateStoreCreditMutation, Exact<{
    input: StoreCreditAddInput;
}>>;
